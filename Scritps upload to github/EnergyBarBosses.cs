...
public class EnergyBarBosses : MonoBehaviour
{
    
    public SpriteRenderer energy;
    public Sprite[] energysprites;
    public BossStandarCode enemy;

    // Start is called before the first frame update
    void Start()
    {
         BossStandarCode enemy = gameObject.GetComponent<BossStandarCode>(); ;
       // CyclopRain enemy = gameObject.GetComponent<CyclopRain>();
        //enemy = gameObject.GetComponent<GameObject>();
